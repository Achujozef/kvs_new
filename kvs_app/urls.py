...
urlpatterns = [
    ...
    path('join-kvs-renew/<int:member_id>/', views.renew_membership, name='renew_membership'),
    path('join-kvs-renewal-history/<int:member_id>/', views.join_kvs_renewal_history, name='join_kvs_renewal_history'),
    path('join-kvs-renewal-export/<int:member_id>/', views.join_kvs_renewal_export_csv, name='join_kvs_renewal_export_csv'),
