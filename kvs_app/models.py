...
class Join_Kvs(models.Model):
    ...
    id_proof = models.ForeignKey(Id_details_choices, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    renewal = models.CharField(max_length=25,choices=renewal_choices,blank=True,null=True)
    insurance_status = models.CharField(max_length=25,choices=insurance_choices,blank=True,null=True)
